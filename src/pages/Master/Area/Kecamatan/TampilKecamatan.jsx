...
const TampilKecamatan = () => {
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(10);
    doc.text(
      `Dicetak Oleh: ${user.namaKecamatan} | Tanggal : ${current_date} | Jam : ${current_time}`,
      15,
      290
    );
    doc.autoTable({
    ...
    <Container>
      ...
      <Box sx={buttonModifierContainer}>
        <Button
          ...
          size="small"
          onClick={() => {
            navigate(`/kecamatan/tambahKecamatan`);
          }}
        >
          Tambah
        </Button>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-slide-description">
                  {`Yakin ingin menghapus data ${kodeKecamatan}?`}
                </DialogContentText>
              </DialogContent>
              <DialogActions>
                <Button onClick={() => deleteKecamatan(id)}>Ok</Button>
