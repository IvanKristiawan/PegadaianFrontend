...
const TampilCabang = () => {
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(10);
    doc.text(
      `Dicetak Oleh: ${user.namaCabang} | Tanggal : ${current_date} | Jam : ${current_time}`,
      15,
      290
    );
    doc.autoTable({
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-slide-description">
                  {`Yakin ingin menghapus data ${cabangId}?`}
                </DialogContentText>
              </DialogContent>
              <DialogActions>
                <Button onClick={() => deleteCabang(id)}>Ok</Button>
